...
Backend api given on [ASP.NET Core Web API repo](https://github.com/Ritabrata-Goswami/ASP.NET-Core-Web-API-for-Windows-Form-GUI-application)
...
2.```Insert form```
![Alt Text](./Project_Images/LoginGUI_Img-2.png)
